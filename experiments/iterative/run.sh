...
$EXEC --model_name $MODEL_NAME --model_nickname $MODEL_NICKNAME --base_path $BASE_PATH --num_samples $NUM_SAMPLES --base_date $TAG --num_groups $NUM_GROUPS --start_iter $ITER